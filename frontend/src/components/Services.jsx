const Services = () => {
    return (
        <div>
            ...
            <section class="banner-section set-bg" style={{backgroundImage: "url('img/banner-bg.jpg')"}}>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="bs-text service-banner">
                                ...
                                <a href="https://www.youtube.com/watch?v=EzKkl64rRbM" class="play-btn video-popup" target="_blank"><i
